        ...
        <div class="p-[16px] gap-y-[20px] overflow-y-auto  gap-[16px] flex flex-col">
            <div class="flex justify-between items-center w-full">
                ...
                <div class="flex gap-[16px] items-center">
                    ...
                    <router-link v-if="propertyData" :to="`/properties/${propertyType}/${propertyData.id}/landmarks/create`" class="px-[16px] py-[10px] rounded-[10px] bg-ui-color border border-ui-color text-white text-base font-medium transition
            ...
            <table class="min-w-full border-collapse rounded-[10px] overflow-hidden bg-off-white border-separate border-spacing-0 relative z-10 pb-[140px]">
                <thead>
                    <tr class="h-[40px] bg-white text-black/60 font-medium text-base text-left">
                        ...
                        <th class="px-[24px] py-[8px]">Landmark Name</th>
                ...
                <tbody>
                    <template v-if="properties && properties.data" v-for="(property, index) in properties.data" :key="property.id">
                        ...
                        <tr class="h-[40px] bg-white text-black font-normal text-base text-left font-light">
                            ...
                            <!-- <td class="px-[24px] py-[8px] text-base font-normal">{{ property.content }}</td> -->
                            ...
                            <td class="px-[24px] py-[8px]  relative w-[150px]">
                                ...
                                <div
                                    ...
                                    <router-link :to="`/properties/${propertyType}/${route.params.id}/landmarks/${property.id}`"
...
<script setup>
    ...
    onMounted( async () => {
        ...
        pageTitle.setTitle(`Landmarks List`);
        pageTitle.setBreadcrumbs(['Properties', property_type, await propertyData.value ? propertyData.value.name : '', 'Landmarks']);
    ...
    const fetchRecords = async () => {
        try {
            ...
            const properties_response = await nuxtApp.$axios.get(`/cms/landmarks?page=${pagination.page}
