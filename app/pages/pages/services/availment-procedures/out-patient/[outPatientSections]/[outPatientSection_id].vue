...
const id = route.params.outPatientSection_id;
...
const submit = async () => {
    ...
    if (isAvailmentInstructionsSection.value && formData.pdf && formData.pdf.length > 0) {
        ...
        try {
            await nuxtApp.$axios
                ...
                .then(response => {
                    ...
                    if (isAvailmentInstructionsSection.value) formData.pdf = [];
