<template>
    <div class="relative flex flex-col justify-start p-[16px] mb-[32px] w-full gap-y-[16px] overflow-y-auto">
        <Form v-if="sectionData && formattedTitle" id="form" @submit="submit()" @invalid-submit="onInvalidSubmit"
            ...
            <!-- Claim Requirements PDF upload (limited to 1) -->
            <div
            ...
            >
                ...
                <p class="text-sm text-black/60">
                    Upload a single PDF for this Claim Requirements section.
                </p>
                <ImageHandler
                    label="PDF File"
                    :data="pdfFiles"
            ...
            <!-- Images and Buttons removed for this section as requested -->
...
const id = route.params.claimsSection_id;
...
// Existing PDF files attached to this section
...
const submit = async () => {
    ...
    // Append PDF file(s) – UI restricts to max 1 when enabled
