    ...
    <transition name="fade">
      ...
      >
        <div
          ...
          @click.stop
        >
          <button @click="closePopup" class="block p-[10px] absolute right-0 top-0">
            <svg
          ...
          <div class="flex items-center gap-[16px] mx-auto w-max">
            ...
            <button class="main-button bg-red-500" @click="deleteRecord">
              Yes, I'm sure
            </button>
          </div>
        </div>
...
const deleteRecord = async () => {
  try {
    if (props.deletePath) {
      await nuxtApp.$axios.post(`${props.deletePath}`, props.form_data);
    }
